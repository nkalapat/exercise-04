...
play_wordle <- function(solution, valid_list, num_guesses=6) {
  ...
  correct <- FALSE # checks if the solution was correctly guessed
  while(guess_num <= num_guesses & correct == FALSE) { # checks if the guess counter has exceeded the number of allowed guesses
  ...
  if(guess_num > num_guesses & correct == FALSE) { # only runs if number of guesses exceeds allowed number
